...
// node_modules/.pnpm/weakmap-polyfill@2.0.4/node_modules/weakmap-polyfill/weakmap-polyfill.js
var require_weakmap_polyfill = __commonJS({
  "node_modules/.pnpm/weakmap-polyfill@2.0.4/node_modules/weakmap-polyfill/weakmap-polyfill.js"(exports) {
    (function(self2) {
      "use strict";
      if (self2.WeakMap) {
        return;
...
// node_modules/.pnpm/omi@7.7.13/node_modules/omi/dist/omi.module.js
var import_weakmap_polyfill = __toESM(require_weakmap_polyfill());

// node_modules/.pnpm/reactive-signal@2.0.1/node_modules/reactive-signal/dist/index.modern.js
var e = null;
var s = false;
...
function U(e2, t2, n3, r3) {
  ...
  return !V && y2 && 1 === y2.length && "string" == typeof y2[0] && null != h3 && void 0 !== h3.splitText && null == h3.nextSibling ? h3.nodeValue != y2[0] && (h3.nodeValue = y2[0]) : (y2 && y2.length || null != h3) && ("Component" == i3.constructor.is && i3.constructor.noSlot || W(i3, y2, V || null != v2.unsafeHTML, n3, r3)), (function(e3, t3, n4, r4, o4) {
    ...
    if (e3.receiveProps && (s4 = Object.assign({}, n4), e3)) {
      if (e3.constructor.defaultProps) {
        var c4 = e3.constructor.defaultProps;
        for (var u4 in c4) void 0 === s4[u4] && (s4[u4] = c4[u4]);
      }
      if (e3.constructor.props) {
        var l3 = e3.constructor.props;
        for (var p4 in l3) {
          var d4;
          void 0 !== (null == (d4 = l3[p4]) ? void 0 : d4.default) && void 0 === s4[p4] && (s4[p4] = l3[p4].default);
        }
      }
    }
    for (i4 in n4) t3 && null != t3[i4] || null == n4[i4] || (_(e3, i4, n4[i4], n4[i4] = void 0, I || D), a4 && delete e3.props[i4]);
    for (i4 in t3) if (a4 && "object" == typeof t3[i4] && "ref" !== i4) {
      ("style" === i4 || "o" === i4[0] && "-" === i4[1]) && _(e3, i4, n4[i4], n4[i4] = t3[i4], I || D);
      var h4 = f2(i4);
      e3.props[h4] = n4[h4] = t3[i4];
    } else if ("children" !== i4 && (!(i4 in n4) || t3[i4] !== ("value" === i4 || "checked" === i4 ? e3[i4] : n4[i4]))) if (_(e3, i4, n4[i4], t3[i4], I || D), -1 !== e3.nodeName.indexOf("-")) {
      e3.props = e3.props || {};
      var v3 = f2(i4);
      e3.props[v3] = n4[v3] = t3[i4];
    } else n4[i4] = t3[i4];
...
var ee = (function(n3) {
  ...
  return u3.executeHooks = function(e2) {
    ...
    if (this.props.css && e2) {
      ...
      return h2(e2) ? [].concat(e2, [t2]) : [e2, t2];
    }
    return e2;
    ...
    var r3, o4 = this.appendStyleVNode(this.render(this.props, this.store));
    this.rendered(o4), c(), this.rootElement = H(null, o4, null, this, false), h2(this.rootElement) ? this.rootElement.forEach(function(e2) {
      var t2;
    ...
    var r3 = this.appendStyleVNode(this.render(this.props, this.store));
    this.rendered(r3), c(null), this.rootElement = H(this.rootElement, r3, this.renderRoot, this, !!n4), this.updated(), this.fire("updated", this);
